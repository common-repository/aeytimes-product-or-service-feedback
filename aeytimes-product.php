...
/*
 * Plugin Name: Aeytimes Product or Service Feedback / Comments Widget
 * Plugin URI: http://aeytimes.com/
 * Author: Alexey Yermolai
 * Author URI: http://aeytimes.com/
 * Version: 1.0.6
 * Description: Displays the latest comments and feedback for a product or service.
 */
...
function addAeytimesProductRSSWidgetOptions() {
	echo '<div class="wrap">';
	echo '<h2>Instructions for using the Aeytimes Product or Service Feedback / Comments Widget</h2>';
	...
	echo '<p>To start using the Aeytimes Product or Service Feedback / Comments Widget:</p>';
	echo '<ol>';
	...
	echo '<li>Title the name of your idea something like "Feedback for YOURPRODUCT", where YOURPRODUCT is the name of your product or service.</li>';
	echo '<li>Once you complete the rest of the idea submission process, a URL with the idea number can be found after the forward slash after the word "ideas" ( eg http://aeytimes.com/ideas/###/Feedback_for_YourProduct ).</li>';
...
function addAeytimesProductRSSWidgetOptionsPage() {
	add_options_page('Product Feedback Options', 'Product Feedback', 'manage_options', 'aeytimes-product', 'addAeytimesProductRSSWidgetOptions' );
}

add_action('admin_menu', 'addAeytimesProductRSSWidgetOptionsPage' );
